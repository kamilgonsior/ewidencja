...
# If not owner ID is set
if (!isset($_GET['id'])) {
    header("Location: index.php");
    exit;
}

# Get owner ID from GET request
$id = $_GET['id'];
...
<body>
    <div class="container">
        ...
        <h1 class="display-4 p-3 fs-3">
            <a href="index.php"
               class="nd">
                <img src="img/back_arrow.png" width="35">
            </a>
            <?=$current_owner['name']?>
        </h1>
