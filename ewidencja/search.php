...
$devices = search_devices($conn, $key);
...
<body>
    <div class="container">
        ...
        Wyszukanie dla <b><?=$key?></b>

        <div class="d-flex pt-3">
            <?php if ($devices == 0) { ?>
                <div class="alert alert-warning text-center p-5 pdf-list" 
                     role="alert">
                <img src="img/empty_search.png" witdh="100">
                <br>
                Słowo klucz <b>"<?=$key?>"</b> nie znalazło rozwiązania w bazie danych 
                </div>
                    <?php }else{ ?>
